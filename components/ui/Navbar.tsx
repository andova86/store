...
import { AppBar, Badge, Box, FormControlLabel, IconButton, Link, Toolbar, Tooltip } from "@mui/material";
import NextLink from "next/link";
import { useRouter } from "next/router";
import React, { useEffect, useState } from "react";
import { RootState } from "../../redux/store";
import { useDispatch, useSelector } from "react-redux";
import { isDarkSet, isOpenMenuSet } from "../../redux/slices";
...
export const Navbar = (props: HomeProps) => {
    ...
    return (
        <HideOnScroll {...props}>
            <AppBar>
                <Toolbar>
                    <Box display={'flex'} flexDirection='column' sx={{ width: '100%', my: 2 }}>
